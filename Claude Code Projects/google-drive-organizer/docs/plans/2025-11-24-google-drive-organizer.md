...
```python
GDRIVE_ROOT = "$HOME/Library/CloudStorage/GoogleDrive-your-email@domain.com"
MY_DRIVE = f"{GDRIVE_ROOT}/My Drive"
CLIENTS_FOLDER = f"{GDRIVE_ROOT}/Shared drives/Enterprise/Clients"
PROJECT_DIR = "$HOME/Documents/Claude Projects/google-drive-organizer"
```
...
# Google Drive paths
GDRIVE_ROOT = Path("$HOME/Library/CloudStorage/GoogleDrive-your-email@domain.com")
MY_DRIVE = GDRIVE_ROOT / "My Drive"
CLIENTS_FOLDER = GDRIVE_ROOT / "Shared drives/Enterprise/Clients"

# Project paths
PROJECT_DIR = Path("$HOME/Documents/Claude Projects/google-drive-organizer")
...
Run: `mkdir -p "$HOME/Documents/Claude Projects/google-drive-organizer/output"`

**Step 4: Commit**

```bash
cd "$HOME/Documents/Claude Projects/google-drive-organizer"
git init
git add src/
...
Run: `cd "$HOME/Documents/Claude Projects/google-drive-organizer" && python3 src/clients.py`
...
Run: `cd "$HOME/Documents/Claude Projects/google-drive-organizer" && python3 src/scanner.py`
...
Run: `cd "$HOME/Documents/Claude Projects/google-drive-organizer" && python3 src/preview.py`
...
Run: `python3 -m py_compile "$HOME/Documents/Claude Projects/google-drive-organizer/src/execute.py"`
...
Run: `chmod +x "$HOME/Documents/Claude Projects/google-drive-organizer/organize.py"`

**Step 3: Test help**

Run: `cd "$HOME/Documents/Claude Projects/google-drive-organizer" && python3 organize.py`
...
Run: `cd "$HOME/Documents/Claude Projects/google-drive-organizer" && python3 organize.py preview`
...
Run: `ls -la "$HOME/Documents/Claude Projects/google-drive-organizer/output/"`

Expected: preview_*.csv file exists

**Step 3: Check first few lines of CSV**

Run: `head -20 "$HOME/Documents/Claude Projects/google-drive-organizer/output/preview_"*.csv`
...
Run: `cd "$HOME/Documents/Claude Projects/google-drive-organizer" && python3 organize.py execute output/preview_*.csv`
...
```bash
cat > "$HOME/Documents/Claude Projects/google-drive-organizer/README.md" << 'EOF'
# Google Drive Organizer
